...
import { User, Tractor, Phone, MapPin, Save, Loader2, Camera } from "lucide-react";
...
export default function FarmerProfilePage() {
  ...
  const profileRef = useMemoFirebase(() => {
    ...
    return doc(db, "users", user.uid, "farmerProfile", "profile");
  }, [db, user]);
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8 max-w-2xl">
        <header className="mb-8">
          <h1 className="text-3xl font-headline font-bold mb-2">Farmer Profile</h1>
          <p className="text-muted-foreground">Manage your farm identity and contact information.</p>
        </header>
        ...
        <form onSubmit={handleUpdateProfile}>
          <Card className="shadow-xl border-primary/10 overflow-hidden">
            <CardHeader className="bg-primary/5 text-center pb-8">
              ...
              <CardTitle className="text-xl">{formData.farmName || "Unnamed Farm"}</CardTitle>
